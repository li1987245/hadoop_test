...
public final class ClassLoaderLeakExample {
  ...
  static final class ChildOnlyClassLoader extends ClassLoader {
    ...
    @Override protected Class<?> loadClass(String name, boolean resolve)
      ...
      try {
          Path path = null;//Paths.get(LoadedInChildClassLoader.class.getName()+ ".class");
          path = Paths.get("E:\\ideaProjects\\hadoop\\target\\classes\\demo\\ClassLoaderLeakExample$LoadedInChildClassLoader.class");
