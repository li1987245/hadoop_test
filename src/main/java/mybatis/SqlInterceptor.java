...
public class SqlInterceptor implements Interceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        if (invocation.getTarget() instanceof RoutingStatementHandler) {
            ...
            StatementHandler delegate = (StatementHandler) ReflectionHelper.getFieldValue(statementHandler, "delegate");
            ...
            if (obj instanceof Page<?>) {
                ...
                MappedStatement mappedStatement = (MappedStatement) ReflectionHelper.getFieldValue(delegate, "mappedStatement");
                ...
                ReflectionHelper.setFieldValue(boundSql, "sql", pageSql);
            }
        }
